...
<?php
include 'koneksi.php';
$query_mysql = mysqli_query($connect, "SELECT * FROM transaksi");
?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="btn-group">
                        <a href="alltransaksi.php" class="btn btn-primary active" aria-current="page">ALL Transaksi</a>
                        <a href="clstr1.php" class="btn btn-primary">Cluster 1</a>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">ALL Transaksi</h6>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="center">
                                                ...
                                                $view = "SELECT * FROM `items` AS i INNER JOIN `alltransaksi` AS t ON i.`ID_ITEMS` = t.`ID_ITEMS` WHERE t.`ID_TRANSAKSI` = '$kode_transaksi'";
