...
<?php
include 'koneksi.php';
$query_mysql = mysqli_query($connect, "SELECT * FROM t_cluster3");
?>
            ...
            <div id="content">
                ...
                <!-- Page Heading -->
                    ...
                    <div class="btn-group">
                      ...
                      <a href="clstr3.php" class="btn btn-primary active" aria-current="page">Cluster 3</a>
                    </div>
                    <hr>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Data Tabel Cluster 3</h6>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="center">
                                                ...
                                                $view = "SELECT * FROM `items` AS i INNER JOIN `cluster3` AS t ON i.`ID_ITEMS` = t.`ID_ITEMS` WHERE t.`ID_TRANSAKSI` = '$kode_transaksi'";
